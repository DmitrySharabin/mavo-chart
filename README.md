...
**Note:** If you don't specify any styling for data series via neither `mv-chart-series-styles` or `mv-chart-theme` the colors will be generated by the plugin automatically and **will be different on every page refresh**.
